        ...
        <div className="bg-white w-96 h-80 right-44 top-24 absolute rounded-md shadow-lg">
          ...
          <div>
            ...
            <div className='flex justify-center font-gumela mt-5 ml-32'>
              <button style={{ borderRadius: '8px', border: '1px solid #2D1843', gap: '10px' }} className='py-2 font-gumela  px-16 ml-1  border flex text-[#0B0B0B] justify-center text-sm items-center'>
